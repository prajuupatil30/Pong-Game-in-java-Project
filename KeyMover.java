...
// project Description: Pong is a classic tennis game which is GUI based. 
//                      This project is a great recipe to test the core java skills as it  
//                      uses simple Multithreading concepts, Swing concepts, OOPs concepts.
...
class Game extends JPanel implements ActionListener
{
	...
	int delay=300; //used to store the delay for the timer
